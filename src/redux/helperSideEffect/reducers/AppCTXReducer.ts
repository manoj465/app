...
export const _actions = {
  ...
  quickActionsRedux: _getBaseAction<{ data: quickIcons_i } & { log?: logger }>(
    _reduxConstant.APPCTX_QUICK_ACTIONS_REDUX
  ),
  notificationsRedux: _getBaseAction<{
    notifications?: notification_props[];
    removeNotificationWithId?: String;
    newNotification?: Omit<notification_props, 'id'>;
