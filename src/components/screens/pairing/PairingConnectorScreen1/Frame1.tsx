        ...
        return (
          ...
          >
            ...
            <Text style={{ color: '#555', fontSize: 15, marginTop: 10, textAlign: 'center', marginHorizontal: 15 }}>
              To proceed with pairing go to your phone Wi-Fi Settings and connect to Wi-Fi naming <Text style={{ fontWeight: 'bold' }}>HUE:_XXXX_XX:XX</Text> with password{' '}
              <Text style={{ fontWeight: 'bold' }}>12345678</Text>
            </Text>
            <Text style={{ fontSize: 12, color: '#555', textAlign: 'center', marginTop: 5 }}>
              <Text style={{ color: STYLES.textColors.warning, fontWeight: 'bold' }}>NOTE:</Text> turn off your mobile data
            </Text>
          </View>
        );
      }}
          ...
          <NewRectButtonWithChildren
            ...
            onPress={async () => {
              const unsupportedDialog = () => {
                Alert.alert(`Jump not Supported`, 'You might want to try switching the HUElite app in background and then go to WiFi Settings');
              };
