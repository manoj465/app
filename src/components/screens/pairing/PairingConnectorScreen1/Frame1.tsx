...
export default (props: { setStep: React.Dispatch<React.SetStateAction<0 | 1 | 2>>, log?: logger }) => {
    ...
    return (
        ...
        <View
            ...
            <View
                ...
                <Text style={{ color: "#555", fontSize: 16, marginTop: 10, textAlign: "center", marginHorizontal: 15 }}>To proceed with pairing go-to your phone Wi-Fi Settings and connect to Wi-Fi naming <Text style={{ fontWeight: "bold" }}>HUE:_XXXX_XX:XX</Text> with password <Text style={{ fontWeight: "bold" }}>12345678</Text></Text>
                    ...
                    <View>
                        ...
                        <NewRectButtonWithChildren
                            ...
                            <View style={{
                                ...
                                <Text style={{ color: "#55f", fontSize: 18 }}>goto Wifi settings</Text>
                            </View>
                        </NewRectButtonWithChildren>
