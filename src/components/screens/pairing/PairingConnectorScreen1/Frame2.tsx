...
const deviceNames = ['Bedroom Light', 'Kitchen', 'Garden Light', 'Balcony', 'SwimmingPool'];
...
export default ({ navigation, setStep, show, ...props }: Props) => {
  ...
  return (
            ...
            >
              ...
              >
                <Text style={{ fontSize: 10, fontWeight: 'bold', color: '#55f' }}>
                  {frame2steps == 0 ? 'Refresh WiFi Scan' : 'Selected Network : ' + Wifi}
                </Text>
              </View>
            </NewRectButtonWithChildren>
          </View>
    ...
    >
      ...
      {false && (
        ...
        >
          <Text style={{ fontSize: 12, fontWeight: 'bold', color: 'white' }}>Enter Device Name</Text>
          <TextInput
            style={{
              height: 50,
              width: '100%',
            ...
            if (props.frame2steps == 0) {
              ...
              if (props.Wifi && props.pass && props.pass.length >= 8) {
                ...
                NOTIFY({
                  ...
                  subTitle:
                    'if your network is open, then we recommend to configure your wifi router with password prior pairing process',
                  type: 'ALERT',
                });
              }
              ...
              if (pairStatus == pairing_state_e.PAIR_SUCCESS) {
                ...
                if (props.Wifi && props.pass && props.pass.length >= 8) pair(props.Wifi, props.pass);
                else {
                  NOTIFY({
                    topic: 'PAIRING',
        ...
        <NewRectButtonWithChildren
          ...
          onPress={() => {
            if (props.frame2steps == 0) {
              ...
              console.log('continue without pairing');
              if (props.newDevice) {
                let newDevice = { ...props.newDevice, IP: '192.168.4.1' };
                appOperator.device({
                  cmd: 'ADD_UPDATE_DEVICES',
                  newDevices: [newDevice],
                });
                props.navigation.replace('setupDevice', { device: newDevice });
              }
            } else if (props.frame2steps == 1) {
              props.setFrame2steps(0);
            } else if (props.frame2steps == 2) {
      ...
      {data?.RES?.networks != undefined ? (
        ...
        >
          ...
          <LottieView
            ...
            source={require('../../../../../assets/lottie/scanning-2.json')}
            autoPlay
            loop={true}
            //progress={progress}
          />
