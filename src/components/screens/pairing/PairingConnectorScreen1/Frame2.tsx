        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                <Text style={{ fontSize: 10, fontWeight: 'bold', color: '#55f' }}>{frame2steps == 0 ? 'Refresh WiFi Scan' : 'Selected Network : ' + Wifi}</Text>
              </View>
            </NewRectButtonWithChildren>
          </View>
        );
              ...
              {data?.RES?.networks.map((item: any, index: number) => {
                ...
                return (
                  <View key={index}>
                    ...
                    {data?.RES?.networks && index == data?.RES?.networks?.length - 1 && <View style={{ height: 60 }}></View>}
                  </View>
                );
              })}
            </Animated.ScrollView>
