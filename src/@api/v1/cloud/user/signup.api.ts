...
export const v1: (props: fun_t) => Promise<_signupAPi_returnType> = async ({
  email,
  password,
  userName,
  log,
      ...
      if (props.ERR?.error) {
        ...
        if (props.ERR.error.message) {
          if (
            ...
            return {
              ERR: { errCode: signupApiErrors_e.SIGNUP_API_PASSWORD_TOO_SHORT, errMsg: props.ERR.error.message },
            };
          } else if (
            ...
            return {
              ERR: { errCode: signupApiErrors_e.SIGNUP_API_PASSWORD_NOT_STRONG, errMsg: props.ERR.error.message },
            };
           ...
           */
            return {
              ERR: { errCode: signupApiErrors_e.SIGNUP_API_EMAIL_ALREADY_REGISTERED, errMsg: props.ERR.error.message },
            };
          }
        }
